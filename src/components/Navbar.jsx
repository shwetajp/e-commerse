    ...
    <>
      <div className="head">
        ...
        <div className="form-inline my-2 my-lg-0">
            ...
            <div className="dropdown" style={{ marginRight: "20px" }}>
              ...
              {isOpen && (
                <div className="dropdown-menu" style={{ display: "block" }}>
                  ...
                  <Link to="/favourite" className="dropdown-item">
                    Favourite Page
                  </Link>
                </div>
              )}
          ...
          <Link to="/favourite">
            {" "}
            <span className="item-numbers-length">
              {myFavouritePage.length}
            </span>
            <label htmlFor="image">
              <FiHeart fontSize={30} />
            </label>
          ...
          <Link to="/cart">
            {" "}
            <span className="item-numbers-length">{myCart.length}</span>{" "}
            <label htmlFor="image">
              <BsCart3 fontSize={40} />
      ...
      <nav className="navbar">
        <div className="navbar-container">
          <ul className="navbar-ul">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/subcat">
                Jewelery
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/mencloth">
                Men's clothing
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/womencloth">
                Women's clothing
              </Link>
            </li>
          </ul>
